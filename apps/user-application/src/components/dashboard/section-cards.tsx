...
export function SectionCards() {
  return (
    <div className="grid gap-4 *:data-[slot=card]:bg-linear-to-t *:data-[slot=card]:from-muted/50 *:data-[slot=card]:to-muted/10 *:data-[slot=card]:border-muted/50 md:grid-cols-3">
