...
const AuthAppPolarSubscriptionsRoute = AuthAppPolarSubscriptionsRouteImport.update({
...
const AuthAppPolarCheckoutSuccessRoute = AuthAppPolarCheckoutSuccessRouteImport.update({
...
const StaticRouteRouteWithChildren = StaticRouteRoute._addFileChildren(StaticRouteRouteChildren);
