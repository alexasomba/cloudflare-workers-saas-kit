...
import { AtIcon, CaretLeftIcon } from '@phosphor-icons/react';
import { Button } from '@workspace/components/button';
import { FloatingPaths } from '@workspace/components/floating-paths';
      ...
      <div className="relative hidden h-full flex-col border-r bg-secondary p-10 lg:flex dark:bg-secondary/20">
        ...
        <div className="z-10 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-xl">
              &ldquo;This Platform has helped me to save time and serve my clients faster than ever
              before.&rdquo;
            </p>
