...
import { type FREQUENCY, FrequencyToggle } from '@workspace/components/frequency-toggle';
...
export function PricingCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn('mt-auto w-full border-t p-3', plan.highlighted && 'bg-card dark:bg-card/80')}
      >
        <Button
          className="w-full"
