import { Avatar, AvatarFallback, AvatarImage } from '@workspace/components/avatar';
import { InfiniteSlider } from '@workspace/components/infinite-slider';
    ...
    <section className="relative py-10">
      <div className="mx-auto max-w-5xl">
        <div className="mx-auto flex max-w-sm flex-col items-center justify-center gap-4">
          ...
          <h2 className="font-bold text-3xl tracking-tighter lg:text-4xl">What our users say</h2>
    ...
    >
      ...
      <figcaption className="mt-5 flex items-center gap-2">
        ...
        <div className="flex flex-col">
          <cite className="font-medium not-italic leading-5 tracking-tight">{name}</cite>
